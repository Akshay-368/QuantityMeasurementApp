...
public class MenuClass : IMenu
{
    public  void StartMenu()
    {
        ...
        while (running)
        {
            ...
            Console.WriteLine("2. Convert Length"); // for uc - 5
            Console.WriteLine("3. Add Lengths ");  // for uc - 6
            // ( For UC-6 : Returns ans in unit of first one's value , For UC-7 : you can choose unit )
