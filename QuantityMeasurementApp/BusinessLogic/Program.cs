...
and to remove it from the solution :
dotnet sln QuantityMeasurementApp.sln remove ..\QuantityMeasurement.WinUI\QuantityMeasurement.WinUI.csproj ( from the BusinessLogic folder )and then use dotnet clean and dotnet build
